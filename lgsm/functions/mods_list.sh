...
mod_info_deathrun=( MOD "deathrun" "Arizard's Deathrun" "https://github.com/Arizard/deathrun/archive/master.zip" "deathrun-master.zip" "0" "LowercaseOff" "${systemdir}/gamemodes" "deathrun-master/deathrun.txt" "ENGINES" "Garry's Mod;" "NOTGAMES" "https://steamcommunity.com/groups/vhs7" "Arizard's Deathrun gamemode for Garry's Mod" )
